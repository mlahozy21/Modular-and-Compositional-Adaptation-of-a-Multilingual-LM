...
of where the optimiser began. The step budget is fixed in advance, and validation
and test are read only once it has run out. These per-layer $\lambda$, unlike the
...
range of those five numbers. What that figure separates is two \emph{mixtures},
