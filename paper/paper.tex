...
of where the optimiser began. The step budget is three passes over the training
split, set in advance rather than by a stopping criterion, and validation and
test are read only once it has run out. These per-layer $\lambda$, unlike the
